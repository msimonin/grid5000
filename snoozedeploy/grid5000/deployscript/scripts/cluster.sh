...
start_cluster () {
     ...
     list_cluster_addresses
     # bootstrap
     put_taktuk "$tmp_directory/bootstrap_nodes.txt" "$local_scripts_directory/cluster_helper.sh" "$remote_scripts_directory/cluster_helper.sh"
     put_taktuk "$tmp_directory/bootstrap_nodes.txt" "$local_scripts_directory/start_bootstrap.sh" "$remote_scripts_directory/start_bootstrap.sh"
     run_taktuk "$tmp_directory/bootstrap_nodes.txt" exec "[ $remote_scripts_directory/start_bootstrap.sh ]"
     
     # gms
     put_taktuk "$tmp_directory/group_managers.txt" "$local_scripts_directory/cluster_helper.sh" "$remote_scripts_directory/cluster_helper.sh"
     put_taktuk "$tmp_directory/group_managers.txt" "$local_scripts_directory/start_groupmanager.sh" "$remote_scripts_directory/start_groupmanager.sh"
     run_taktuk "$tmp_directory/group_managers.txt" exec "[ $remote_scripts_directory/start_groupmanager.sh ]"

     # local controller
     put_taktuk "$tmp_directory/local_controllers.txt" "$local_scripts_directory/cluster_helper.sh" "$remote_scripts_directory/cluster_helper.sh"
     put_taktuk "$tmp_directory/local_controllers.txt" "$local_scripts_directory/start_localcontroller.sh" "$remote_scripts_directory/start_localcontroller.sh"
...
stop_cluster () {
     ...
     put_taktuk "$tmp_directory/bootstrap_nodes.txt" "$local_scripts_directory/stop_bootstrap.sh" "$remote_scripts_directory/stop_bootstrap.sh"
